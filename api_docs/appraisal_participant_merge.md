# AppraisalParticipantMerge (Создание или объединение причины участия)
...
В случае создания записи будет возвращен статус ```201 Created```. В случае нахождения такого участника по заданному анкетированию, будет обновлено поле participationReason. В теле ответа JSON с идентификатором созданной сущности:
